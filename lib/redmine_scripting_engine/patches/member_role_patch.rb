    ...
    module MemberRolePatch
      def self.included(base)
        base.class_eval do
          ...
          ################################################################################
          # a change of a member role may lead to a change in visibility of scripts
          ################################################################################
...
unless MemberRole.included_modules.include?(RedmineScriptingEngine::Patches::MemberRolePatch)
  MemberRole.send(:include, RedmineScriptingEngine::Patches::MemberRolePatch)
end
