    ...
    module RolePatch
      def self.included(base)
        base.class_eval do
          ...
          ################################################################################
          # a change of permissions may lead to a change in visibility of scripts
          ################################################################################
...
unless Role.included_modules.include?(RedmineScriptingEngine::Patches::RolePatch)
  Role.send(:include, RedmineScriptingEngine::Patches::RolePatch)
end
